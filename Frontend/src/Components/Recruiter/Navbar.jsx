...
const RecruiterNavbar = () => {
  ...
  const navLinks = [
    ...
    { name: 'Post Job', path: '/recruiter/postjobs', icon: PlusCircle },
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative hidden md:block">
              ...
              >
                <div className="w-9 h-9 bg-gradient-to-br from-orange-600 to-purple-500 rounded-full flex items-center justify-center">
          ...
          <div className="px-4 py-4 space-y-2">
            ...
            <div className="pt-4 border-t border-gray-200 space-y-2">
              <div className="flex items-center gap-3 px-4 py-2">
                <div className="w-10 h-10 bg-gradient-to-br from-orange-600 to-purple-500 rounded-full flex items-center justify-center">
